...
const CreatePost = () => {
    ...
    const generateImage = async () => {
        if(form.prompt) {
            try {
                ...
                // DEPLOYED SERVER:
                const response = await fetch("https://luksi02-mern-image-generator.onrender.com/api/v1/dalle", {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if(form.prompt && form.photo) {
            console.log('prompt and photo')
            setLoading(true);

            try {
                console.log('trying to retrive response')
                // LOCAL SERVER:
        ...
        <section className="max-w-7xl mx-auto">
            ...
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
                    Create imaginative and visually stunning images through DALL-E AI and share them with comminity
                </p>
            </div>
                ...
                <div className="mt-5 flex gap-5">
                    <button
                        ...
                        className="text-white bg-green-700 font-medium rounded-md text-sm w-full
                            sm:w-auto px-5 py-2.5 t ext-center"
                    >
